...
namespace Restify
{
    public static class ConfigurationExports
    {
        ...
        // This is different from how static members that are linked at run-time work,
        // if you change any of these values, you need to recompile all assemblies that reference this one!
